...
package net.mcreator.shardsoftheglobe.world.biome;
...
public class FlatBiome extends ShardsOfTheGlobeModElements.ModElement {
	public static Biome biome;
	public FlatBiome(ShardsOfTheGlobeModElements instance) {
		super(instance, 6);
	...
	private static class BiomeRegisterHandler {
		...
		public void registerBiomes(RegistryEvent.Register<Biome> event) {
			if (biome == null) {
				...
				biome = new Biome.Builder().precipitation(Biome.RainType.NONE).category(Biome.Category.PLAINS).depth(0f).scale(0f).temperature(0.5f)
						.downfall(0f).setEffects(effects).withMobSpawnSettings(mobSpawnInfo.copy())
						.withGenerationSettings(biomeGenerationSettings.build()).build();
				event.getRegistry().register(biome.setRegistryName("shards_of_the_globe:flat"));
			}
		}
	}
	@Override
